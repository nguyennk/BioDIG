# Django settings for mycoplasma_site project.
...
MEDIA_ROOT = '/var/www/BioDIG/taxon_home/media'
...
STATIC_ROOT = '/var/www/BioDIG/static'
...
STATICFILES_DIRS = (
    ...
    '/var/www/BioDIG/taxon_home/static',
)
