...
'''
def updateGeneLink(request, key):
    if not key:
        raise Errors.NO_TAG_GROUP_KEY
    ...
    return putAPI.updateGeneLink(key, name)
...
'''
def deleteGeneLink(request, key):
    ...
    return deleteAPI.deleteGeneLink(key)
